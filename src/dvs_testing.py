...
def start_test(model_filename):
    ...
    # WandB metrics. Uncomment to log them in the dashboard
    # metrics = []
    ...
    # Metrics for T-Test
    metrics = {"mAP": np.mean(APs), "mIoU": np.mean(IoUs), "mAcc": np.mean(ACCs)}
...
if __name__ == '__main__':
    start_test(model_filename="noisy_20ep.h5")
